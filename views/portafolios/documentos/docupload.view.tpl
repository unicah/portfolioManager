...
<div class="row depth-1 m-padding">
  ...
  {{endif haserrores}}
  <form action="index.php?page=docupload" method="post" enctype="multipart/form-data"
    class="col-sm-8 col-sm-offset-2 col-md-6 col-offset-3">
    ...
    <div class="row s-padding">
      ...
      <input class="col-sm-7" {{readonly}} type="text" name="documentoportafoliocodigo" id="documentoportafoliocodigo" value="{{documentoportafoliocodigo}}" placeholder="Código Documento" />
    </div>

    <div class="row s-padding">
      <label class="col-sm-5">Descripción</label>
      <input class="col-sm-7" {{readonly}} type="text" name="documentodescripcion" id="documentodescripcion" value="{{documentodescripcion}}" placeholder="Descripción Corta del Documento" max="120" />
    </div>

    <div class="row s-padding">
      <label class="col-sm-5">Categoría</label>
      <span class="select col-sm-7"><select {{if readonly}}disabled readonly="readonly" {{endif readonly}} class="col-md-12" id="categoriaportafolio" name="categoriaportafolio">
        {{foreach categorias}}
